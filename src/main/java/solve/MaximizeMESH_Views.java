...
public class MaximizeMESH_Views {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BaseProblemViews problemBorendy = new BaseProblemViews(new Data(forest, accessible, restorable), 1);
        ...
        // Unia //
        BaseProblemViews problemUnia = new BaseProblemViews(new Data(forest, accessible, restorable), 2);
